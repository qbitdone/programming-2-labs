...
void brisanje() 
{
    ...
    while(brisi)
        ...
        if (brojac==0) cout << "Greška - Nije pronaðen autor s tom sifrom! " << endl;
}
void novi_element() 
{
    element *zadnji,*novi;
